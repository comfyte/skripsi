...
\begin{enumerate}
    ...
    Pada tahap ini, dilakukan pengembangan perangkat lunak FancyWSL dari awal hingga akhir. Mengingat perangkat lunak ini mencakup sejumlah fungsi, tahap ini dibagi menjadi enam subtahap:
    \begin{enumerate}
