...
\begin{itemize}
    \item Istilah "Linux" dapat mengacu kepada \textit{kernel} Linux itu sendiri. \textit{Kernel} Linux pertama kali dirilis oleh pengembang utamanya, Linus Torvalds, pada tahun 1991 \cite{tozzi2016linux}. Saat ini, \textit{kernel} Linux membawahi berbagai sistem operasi atau distribusi yang memiliki "Linux" sebagai bagian dari namanya. Istilah yang mengacu pada definisi ini selanjutnya akan disebut "\textit{kernel} Linux"
    \item Istilah "Linux" juga dapat mengacu kepada distribusi-distribusi Linux utuh yang memakai \textit{kernel} Linux. 
\end{itemize}
