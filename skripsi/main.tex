...
\title{FancyWSL: Penyempurnaan Integrasi \textit{Shell} pada Windows Subsystem for Linux (WSL) dengan Mengimplementasikan Sistem Penanganan Notifikasi dan Kontrol Media guna Meningkatkan Pengalaman Pengguna}
