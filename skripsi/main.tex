...
\title{FancyWSL: Perluasan Komunikasi D-Bus pada Windows Subsystem for Linux (WSL) guna Meningkatkan Integrasi Antarmuka Pengguna Grafis (GUI) dengan \textit{Host} Windows dalam Aspek Notifikasi dan Kontrol Media}
...
\addsupervisor{Muhammad Nur Rizal, S.T., M.Eng.}{<<NIP 197506192002121004>>}
...
% \printendorsement
%\printendorsementpdf
\printendorsementjpg{IMG_9041.JPEG}
