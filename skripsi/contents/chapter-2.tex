...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{|c|p{2.5cm}|X|X|X|} \hline
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{|c|l|X|X|} \hline
        \textbf{No.} & \textbf{Platform} & \textbf{Integrasi \textit{Shell} Windows} & \textbf{Integrasi D-Bus}\\ \hline
        1 & C\# & Tersedia (mengingat C\# adalah salah satu platform \textit{native} di Windows & Terbatas dan kurang terdokumentasi (\textit{undocumented})\\ \hline
        2 & Python & Tersedia melalui \textit{binding} pihak ketiga & Tersedia pustaka-pustaka (\textit{library}) yang beraneka ragam\\ \hline
    \end{tabularx}
\end{table}
