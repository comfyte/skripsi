...
\begin{itemize}
    ...
    \item FancyWSL memiliki kemampuan menggunakan distribusi Linux WSL yang diinginkan melalui argumen \verb|-d <nama-distribusi>| saat penjalanan FancyWSL, sedangkan karya tulis serupa (karya tulis oleh Olsen \cite{olsen-2022-through-the-wormhole}) tidak membahas dukungkan multidistribusi Linux di WSL; dan
