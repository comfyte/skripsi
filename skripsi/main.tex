...
\include{contents/chapter-2}
\include{contents/chapter-3}
\include{contents/chapter-4}
\include{contents/chapter-5}
...
\chapterappendix{contents/appendices/appendix-one}
\chapterappendixadd{contents/appendices/appendix-two}
\chapterappendixadd{contents/appendices/appendix-three}
