...
Pada partisipan pertama, nilai \textit{system usability scale} yang diperoleh yaitu
\[x = (4 + 5 + 3 + 5 + 3) - 5 = 15\]
\[y = 25 - (1 + 1 + 3 + 1 + 1) = 18\]
\[Score = 2,5 * (x + y) = 2,5 * 33 = 82,5\]

Pada partisipan kedua, nilai \textit{system usability scale} yang diperoleh yaitu
\[x = (4 + 5 + 4 + 5 + 3) - 5 = 16\]
\[y = 25 - (1 + 1 + 3 + 2 + 2) = 16\]
\[Score = 2,5 * (x + y) = 2,5 * 32 = 80\]

Pada partisipan ketiga, nilai \textit{system usability scale} yang diperoleh yaitu
\[x = (5 + 5 + 5 + 5 + 1) - 5 = 16\]
\[y = 25 - (1 + 2 + 1 + 1 + 1) = 19\]
\[Score = 2,5 * (x + y) = 2,5 * 35 = 87,5\]

Pada partisipan keempat, nilai \textit{system usability scale} yang diperoleh yaitu
\[x = (4 + 4 + 4 + 3 + 2) - 5 = 12\]
\[y = 25 - (1 + 3 + 4 + 2 + 4) = 11\]
\[Score = 2,5 * (x + y) = 2,5 * 23 = 57,5\]

Pada partisipan kelima, nilai \textit{system usability scale} yang diperoleh yaitu
\[x = (5 + 4 + 5 + 5 + 1) - 5 = 15\]
\[y = 25 - (2 + 1 + 2 + 1 + 1) = 18\]
\[Score = 2,5 * (x + y) = 2,5 * 33 = 82,5\]

Pada partisipan keenam, nilai \textit{system usability scale} yang diperoleh yaitu
\[x = (5 + 5 + 5 + 5 + 1) - 5 = 16\]
\[y = 25 - (1 + 1 + 1 + 1 + 1) = 20\]
\[Score = 2,5 * (x + y) = 2,5 * 36 = 90\]

Bila menilik data \textit{time to task}, partisipan pertama membutuhkan waktu rata-rata \((7,36 + 4,11) / 2 = 5,735\) detik pada lingkungan tanpa FancyWSL dan \((2,45 + 6,76) / 2 = 4,605\) detik pada lingkungan dengan FancyWSL, sedangkan partisipan kedua membutuhkan waktu rata-rata \((16,71 + 11,08) / 2 = 13,895\) detik pada lingkungan tanpa FancyWSL dan \((2,96 + 7,28) / 2 = 5,12\) detik pada lingkungan dengan FancyWSL.
...
%     ybar interval=0.7,
%     title={Hasil Pengujian \textit{Time to Task}}
% ]
% \addplot
%     coordinates {
%         (Ketiga, 10.7, 
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        width=0.8\textwidth,
        bar width=0.5cm,
        title={Pengujian \textit{Time to Task} Skenario Pertama}
    ]
    \addplot coordinates {(P. 1,7.36) (P. 2,16.71) (P. 3,10.7) (P. 4,7.68) (P. 5,6.01) (P. 6,5)};
    \addplot coordinates {(P. 1,2.45) (P. 2,2.96) (P. 3,2.51) (P. 4,2.1) (P. 5,4.7) (P. 6,1.75)};
    \legend{Tanpa FancyWSL,Dengan FancyWSL}
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        width=0.8\textwidth,
        bar width=0.5cm,
        title={Pengujian \textit{Time to Task} Skenario Kedua}
    ]
    \addplot coordinates {(P. 1,4.11) (P. 2,11.08) (P. 3,11.35) (P. 4,5.12) (P. 5,8.06) (P. 6,5.43)};
    \addplot coordinates {(P. 1,6.76) (P. 2,7.28) (P. 3,7.48) (P. 4,9.69) (P. 5,8.78) (P. 6,5.2)};
    \legend{Tanpa FancyWSL,Dengan FancyWSL}
    \end{axis}
\end{tikzpicture}
