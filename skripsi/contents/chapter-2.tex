...
Penyusunan tugas akhir ini tidak terlepas dari karya-karya tulis dan penelitian terdahulu yang menjadi basis, penuntun, ataupun inspirasi penulis dalam melaksanakan seluruh rangkaian penelitian. Mengingat tugas akhir ini melibatkan berbagai jenis teknologi, peninjauan-peninjauan yang dilakukan didasarkan pada berbagai segi:
\begin{enumerate}
    \item implementasi serupa (1 buah karya tulis),
    \item arsitektur penjalanan sistem (2 buah karya tulis), dan
    \item 
\end{enumerate}
