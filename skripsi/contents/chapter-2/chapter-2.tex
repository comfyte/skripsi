...
\begin{enumerate}
    \item perangkat lunak pengelola bus sesi D-Bus (\textit{session manager}) yang menyeragamkan bus D-Bus yang dipakai oleh sesi-sesi WSL yang berbeda dan
...
\begin{figure}
    ...
    \caption{Ilustrasi bus D-Bus \cite{dbus-bus-illustration}}
...
Terdapat sejumlah konsep yang digunakan dalam pengoperasian D-Bus:
\begin{itemize}
    \item 
\end{itemize}
